...
window.addEventListener("DOMContentLoaded", function () {
  "use strict"; // Variable for the modal window, collecting information about user`s choice in the calculator form

  var modalState = {}; // Timer deadline
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])(".container1", dead);
});
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])("#width"); // Hangs a specific event handler on a specific element,
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener("submit", function (event) {
      ...
      var formData = new FormData(item); // Checking for a form that is the last form in calculator form
...
var timer = function timer(id, deadline) {
  ...
  var setClock = function setClock(selector, endtime) {
    var timer = document.querySelector(selector),
        ...
        timeInterval = setInterval(updateClock, 1000); // Starting the function updateClock provides an instant display of
